...
function GeiInvolved() {
  return (
    <div
      ...
      id="getinvolved"
    >
      <h2 className=" gradient-text text-white text-bold text-center  text-3xl md:text-6xl leading-loose .ease-out duration-1000">
        VOTE FOR BETTER BILLS. <br /> VOTE FOR YOUR FUTURE.
      </h2>
      <p className="text-white text-center md:w-1/2 mx-auto py-8 ">
